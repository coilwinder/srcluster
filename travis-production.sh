...
WORK_DIR='/home/ansible/work/semrush/srwork-production'
...
tar --exclude-vcs --create --preserve-permissions --gzip  --file - . \
...
$SSH_CMD "cd ${WORK_DIR} && ./provisioner.sh inventories/production" \
